...
//	@Bean
//	@Autowired
//	DeletionListener deletionListener(final ModRoleRepo roleRepo, final WhitelistedChannelRepo channelRepo) {
//		return new DeletionListener(roleRepo, channelRepo);
//	}
//
//	@Bean
//	@Autowired
...
//
//	@Bean
//	GuildMessageListener guildMessageListener(final Censor censor, final Map<String, Command> commandMap, final WhitelistedChannelRepo channelRepo) {
//		return new GuildMessageListener(censor, commandMap, channelRepo);
//	}
//
//	@Bean
//	@Autowired
